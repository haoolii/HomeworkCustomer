namespace HomeworkCustomer.Models
{
	public static class RepositoryHelper
	{
		...
		public static Customer_Test_ViewRepository GetCustomer_Test_ViewRepository()
		{
			var repository = new Customer_Test_ViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static Customer_Test_ViewRepository GetCustomer_Test_ViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new Customer_Test_ViewRepository();
